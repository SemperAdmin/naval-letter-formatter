    ...
    if (refsWithContent.length > 0) {
      refsWithContent.forEach((ref, i) => {
        ...
        if (formData.bodyFont === 'courier') {
          ...
          content.push(new Paragraph({ children: [new TextRun({ text: refText, font: bodyFont, size: 24 })], tabStops: [{ type: TabStopType.LEFT, position: 720 }], indent: { left: 1040, hanging: 1040 } }));
        }
      });
    }
    ...
    if (enclsWithContent.length > 0) {
      ...
      enclsWithContent.forEach((encl, i) => {
        ...
        if (formData.bodyFont === 'courier') {
          ...
          content.push(new Paragraph({ children: [new TextRun({ text: enclText, font: bodyFont, size: 24 })], tabStops: [{ type: TabStopType.LEFT, position: 720 }], indent: { left: 1040, hanging: 1040 } }));
        }
      });
    }
